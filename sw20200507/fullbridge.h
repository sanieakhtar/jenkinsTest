...
#ifndef FULLBRIDGE_H_
    #define FULLBRIDGE_H_

/*****************************************************************************/
/*!@file fullbridge.h @copyright
...
/*!@file            Fullbridge.h
 *
 * @details         Provides functions to control the fullbridge DC/AC
 *                  converter.
 *****************************************************************************/
...
//      They always do start with the "Fullbridge..."
...
/*!@brief
 * Return values for function setOutputCurrent
 *
 */
typedef enum eFullbridge_Ramp
{
    e_Fullbridge_Ramp__noAction     =   0,
    e_Fullbridge_Ramp__done,
    e_Fullbridge_Ramp__rampUp,
    e_Fullbridge_Ramp__rampDown,
//    e_Fullbridge_Ramp__endOfList
}eFullbridge_Ramp_t;
...
eFullbridge_Ramp_t fullbridge_rampPhase(float new_setpoint, float rampTime);
eFullbridge_Ramp_t fullbridge_rampRef(float new_setpoint, float rampTime);
